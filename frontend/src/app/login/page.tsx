      ...
      <div className="w-full max-w-sm flex flex-col items-center gap-8">
        ...
        <div className="w-full bg-white/5 border border-white/10 rounded-2xl p-6 flex flex-col gap-4">
          ...
          <button
            ...
            className="flex items-center justify-center gap-3 w-full py-2.5 px-4 bg-white hover:bg-white/90 text-[#0a0a0a] font-medium text-sm rounded-xl transition-all duration-150 active:scale-[0.98]"
          >
